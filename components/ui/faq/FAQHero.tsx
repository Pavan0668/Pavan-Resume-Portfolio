...
function useTypewriter(words: string[], speed = 35, startDelay = 500, pauseBetween = 1600) {
...
// Quick info card with 3D tilt
function QuickInfoCard({ icon: Icon, label, value, href, delay }: {
    icon: typeof MapPin;
    label: string;
    value: string;
    href?: string;
...
export function FAQHero() {
    ...
    return (
        <section ref={sectionRef} className="relative pt-32 pb-24 overflow-hidden min-h-[90vh] flex items-center">
            ...
            <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
                <motion.div style={{ y: contentY }}>
                    ...
                    >
                        ...
                        >
                            <RippleButton className="w-full h-full flex items-center gap-3" onClick={scrollToFaq}>
                        ...
                        >
                            <RippleButton className="w-full h-full flex items-center gap-3" onClick={() => {
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
                        ...
                        <QuickInfoCard
                            icon={Phone}
                            label="Phone"
                            value="+91 866 826 2359"
                            href="tel:+918668262359"
                            delay={1.0}
                        />
                        <QuickInfoCard
                            icon={MapPin}
            ...
            <div className="absolute top-[35%] left-[8%] hidden lg:block pointer-events-none" aria-hidden="true">
                <div className="w-10 h-10 rounded-2xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center animate-float-slow" style={{ animationDelay: "1.5s" }}>
                    <Zap className="w-5 h-5 text-purple-500/60" />
                </div>
            </div>
            <div className="absolute bottom-[30%] right-[8%] hidden lg:block pointer-events-none" aria-hidden="true">
                <div className="w-10 h-10 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center animate-float-slow" style={{ animationDelay: "4s" }}>
                    <BookOpen className="w-5 h-5 text-indigo-500/60" />
                </div>
            </div>
